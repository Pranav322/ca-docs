...
class OptimizedVectorDatabase:
    ...
    async def similarity_search_documents_async(self, query_embedding: List[float], top_k: int = 5,
                                               level: str = None, paper: str = None, module: str = None,
                                               chapter: str = None, unit: str = None) -> List[Dict]:
    ...
    async def similarity_search_tables_async(self, query_embedding: List[float], top_k: int = 5,
                                            level: str = None, paper: str = None, module: str = None,
                                            chapter: str = None, unit: str = None) -> List[Dict]:
    ...
    async def get_file_metadata_async(self, file_id: str = None) -> List[Dict]:
        ...
        return await loop.run_in_executor(
            self.executor,
            lambda: self.get_file_metadata(file_id)
        )
